...
if __name__ == '__main__':
    myMaze=maze(15,15)
    myMaze.CreateMaze(6,6,loopPercent=100)

    searchPath,aPath,fwdPath=aStar(myMaze,(15,15))


    a=agent(myMaze,15,15,footprints=True,color=COLOR.blue,filled=True)
    b=agent(myMaze,6,6,footprints=True,color=COLOR.yellow,filled=True,goal=(15,15))
    c=agent(myMaze,15,15,footprints=True,color=COLOR.red,goal=(6,6))
